...
// - a tree in which each nodes has up to 2 children
/*
    Types of Binary Trees
    - Full Binary Tree: Every node other than leaf nodes has 2 child nodes.
    - Complete Binary Tree: every level is fully fill except the last level
    - Perfect Binary Tree: all nodes have two children and all leaves are at a similar level
